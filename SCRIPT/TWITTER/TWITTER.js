...
document.body.addEventListener('click', function(event) {
	...
	if(FUNCTION_SETTINGS.KEYBOARD_NAVIGATION){
		...
		const elementActive1 = document.querySelector("div[role='textbox'][data-testid='tweetTextarea_0']");
			...
			const elementActive4 = document.querySelectorAll("input[type='text']");

			if(Array.from(elementActive4).some(element => element === document.activeElement)){
				return;
			}	
...
const foundArticle = ARTICLES.find(article => {
  const anchor = article.querySelector('article a time').parentElement.href;
  if(anchor==MIDDLE_ARTICLE){
	return anchor;
  }
  return null;
});
if (foundArticle) {
	ARTICLE_MARCADO=foundArticle;
	...
	ARTICLE_MARCADO.focus();
		...
		if(event.key==="ArrowRight"||event.key==="d"&&ARTICLE_MARCADO){
			MIDDLE_ARTICLE = ARTICLE_MARCADO.querySelector("article a time").parentElement.href;
			ARTICLE_MARCADO.querySelector("article").click();
		}

		if(event.key==" "){
			
			if(isNaN(document.querySelector("div[data-testid='cellInnerDiv'] div button[type='button'] span").innerText)){
				event.preventDefault();
			document.querySelector("div[data-testid='cellInnerDiv'] div button[type='button'] span").click();
			}
			else if(document.querySelector("div[role='status'] button")){
				event.preventDefault();
				document.querySelector("div[role='status'] button").click();
			}
		}
		if(event.key=="r"||event.key=="Enter"){
			event.preventDefault();
			setTimeout(function(){
				document.querySelector("div[data-testid='tweetTextarea_0_label'] div[data-testid='tweetTextarea_0']").focus();
				
				document.querySelector("div[data-testid='tweetTextarea_0_label'] div[data-testid='tweetTextarea_0']").scrollIntoView({ behavior: 'smooth', block: 'center' });
			},200);
		}
		if(event.key=="1"){
			document.querySelectorAll("div[data-testid='ScrollSnap-List'] a")[0].click();
		}
		if(event.key=="2"){
			document.querySelectorAll("div[data-testid='ScrollSnap-List'] a")[1].click();
		}
		if(event.key=="3"&&document.querySelectorAll("div[data-testid='ScrollSnap-List'] a")[2]){
			document.querySelectorAll("div[data-testid='ScrollSnap-List'] a")[2].click();
		}
		if(event.key=="4"&&document.querySelectorAll("div[data-testid='ScrollSnap-List'] a")[3]){
			document.querySelectorAll("div[data-testid='ScrollSnap-List'] a")[3].click();
		}
		if(event.key=="5"&&document.querySelectorAll("div[data-testid='ScrollSnap-List'] a")[4]){
			document.querySelectorAll("div[data-testid='ScrollSnap-List'] a")[4].click();
		}
		if(event.key=="6"&&document.querySelectorAll("div[data-testid='ScrollSnap-List'] a")[5]){
			document.querySelectorAll("div[data-testid='ScrollSnap-List'] a")[5].click();
		}
		if(event.key=="7"&&document.querySelectorAll("div[data-testid='ScrollSnap-List'] a")[6]){
			document.querySelectorAll("div[data-testid='ScrollSnap-List'] a")[6].click();
		}
		if(event.key=="8"&&document.querySelectorAll("div[data-testid='ScrollSnap-List'] a")[7]){
			document.querySelectorAll("div[data-testid='ScrollSnap-List'] a")[7].click();
		}
		if(event.key=="9"&&document.querySelectorAll("div[data-testid='ScrollSnap-List'] a")[8]){
			document.querySelectorAll("div[data-testid='ScrollSnap-List'] a")[8].click();
		}
...
function Get_Self_User() {
	try {
		...
		if (container&&document.querySelector("header img")) {
			...
			document.querySelectorAll("div[data-testid='ScrollSnap-List'] a")[0].addEventListener("click",(e)=>{setTimeout(()=>{window.scrollTo(0,0)},1500)});
			document.querySelectorAll("div[data-testid='ScrollSnap-List'] a")[1].addEventListener("click",(e)=>{setTimeout(()=>{window.scrollTo(0,0)},1500)});
			}
